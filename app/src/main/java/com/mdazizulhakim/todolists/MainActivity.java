...
public class MainActivity extends AppCompatActivity {
   ...
   ArrayAdapter<String> taskDoneAdapter;
...
//for undone table
      ...
      Cursor cursor = to_do_list_dataBase.Display_Table_Undone();
        ...
        taskDoneAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_multiple_choice, TASKlist);
        UnDone_Task.setAdapter(taskDoneAdapter);
